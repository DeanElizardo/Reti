...
class TestBishop(unittest.TestCase):
    ...
    def white_bishop_has_right_moves_on_init(self, init_space: Space, expected_spaces: list[Space]):
    ...
    def test_white_init_c1(self):
        init_space = Space('c', 1)
        expected_spaces: list[Space] = self.generate_expected_spaces(init_space)
        self.white_bishop_has_right_moves_on_init(init_space, expected_spaces)

    def test_white_init_f1(self):
        init_space = Space('f', 1)
        expected_spaces: list[Space] = self.generate_expected_spaces(init_space)
        self.white_bishop_has_right_moves_on_init(init_space, expected_spaces)